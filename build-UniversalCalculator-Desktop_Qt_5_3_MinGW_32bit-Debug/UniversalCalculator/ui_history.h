...
public:
    ...
    void setupUi(QDialog *History)
    {
        ...
        History->resize(430, 299);
        History->setMinimumSize(QSize(430, 299));
        History->setMaximumSize(QSize(430, 299));
        pushButton = new QPushButton(History);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(330, 260, 75, 23));
        ...
        tableWidget->setGeometry(QRect(10, 10, 411, 241));
