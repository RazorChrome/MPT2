...
void MainWindow::on_fracCalcAction_triggered()
{
    ui->BasespinBox->hide();
    ui->BasehorizontalSlider->hide();
    ui->label->hide();
    ui->pBA->hide();
    ui->pBB->hide();
    ui->pBC->hide();
    ...
    ui->pBE->hide();
    ui->pBF->hide();
     ui->DotpushButton->setEnabled(false);
    ui->FracpushButton->show();
    ui->SwitchpushButton->show();
    ui->SqrtpushButton->show();
    window()->setFixedSize(498,280);
}


void MainWindow::on_pCalcAction_triggered()
{
    ui->BasespinBox->show();
    ui->BasehorizontalSlider->show();
    ui->label->show();
    ui->pBA->show();
    ui->pBB->show();
    ui->pBC->show();
    ...
    ui->pBE->show();
    ui->pBF->show();
    ui->DotpushButton->setEnabled(true);
    ui->SwitchpushButton->hide();
    ui->FracpushButton->hide();
    ui->SqrtpushButton->hide();
    window()->setFixedSize(498,376);
}

void MainWindow::on_complexCalcAction_triggered()
{
    ui->BasespinBox->hide();
    ui->BasehorizontalSlider->hide();
    ui->label->hide();
